...
The video here below shows the [TAG Selector in the COMPOSER](https://github.com/denvergeeks/discourse-composer-horizontal-tag-selector) Component... but this Component provides the same behavior, but for this *CATEGORY* selector in the *TOPIC LIST* views...
