# Discourse Topic List Horizontal Category Selector
A part of...
## Jen's Discourse Horizonal Selector Components Suite

[This is the TOPIC LIST CATEGORIES Horizonal Selector Component]
...
The video here below shows the example of the [TAG Selector in the COMPOSER](https://github.com/denvergeeks/discourse-composer-horizontal-tag-selector) Component in action... but this Component provides the same behavior, but for this *CATEGORY* selector in the *TOPIC LIST* views...
